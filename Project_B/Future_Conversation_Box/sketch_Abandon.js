...
// Note!!! this sketch is abandoned due to the failure to make each letter appear separately
// it is because that i cannot do it in arrays
...
function setup() {
  ...
  for(let i = 0 ; i  < 11 ; i ++){
    conversations.push(new Conversation(0, windowHeight + 200 * i, Imessage[i]),Theymessage[i]);
  }
...
function contentInput() {
  ...
  conversations.push(new Conversation(0, windowHeight + 200 * 1, "Hia hia hia Exactly. This  is what you always dreamed of.", "What?...Wait! That couldn't be... And how you know all that?!"));
...
function ImessageInput(){
  Imessage.push("Oh! We got a new comer!     Welcome to our city, Ming!");
  Imessage.push("Hia hia hia Exactly. This  is what you always dreamed of.");
  Imessage.push("Well..That's beyond your   knowlege.  I read from your little [MIND]!");
  Imessage.push("Stupid boy.You never       observe with care. Let me  tell you something.");
  Imessage.push("Never noticed this city? So few people live here.");
  Imessage.push("Exactly! There's only me in this future city. I charge everything!");
  Imessage.push("Don't be so rude. It's 'use'. How can I steal from    myself?");
  Imessage.push("Can't deny it. I only      reflect your mind.Your     blueprint of future city.");
  Imessage.push("Hahaha..You finally realize it, my boy.You dream it   day and night.");
  Imessage.push("No friends, no schools, no more pressure... Even no CCLab");
  Imessage.push("How can you escape from    yourself? You shall suffer endless void!...");
}

function TheymessageInput(){
  Imessage.push("Oh! We got a new comer!     Welcome to our city, Ming!");
  Imessage.push("Hia hia hia Exactly. This  is what you always dreamed of.");
  Imessage.push("Well..That's beyond your   knowlege.  I read from your little [MIND]!");
  Imessage.push("Stupid boy.You never       observe with care. Let me  tell you something.");
